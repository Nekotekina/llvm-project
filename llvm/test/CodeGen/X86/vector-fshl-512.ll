...
; AVX512F-NEXT:    vpsllvd %ymm8, %ymm5, %ymm5
; AVX512F-NEXT:    vpsrld $16, %ymm5, %ymm5
...
; AVX512F-NEXT:    vpsllvd %ymm5, %ymm4, %ymm4
; AVX512F-NEXT:    vpsrld $16, %ymm4, %ymm4
...
; AVX512VL-NEXT:    vpsllvd %ymm8, %ymm5, %ymm5
; AVX512VL-NEXT:    vpsrld $16, %ymm5, %ymm5
...
; AVX512VL-NEXT:    vpsllvd %ymm5, %ymm4, %ymm4
; AVX512VL-NEXT:    vpsrld $16, %ymm4, %ymm4
...
; AVX512F-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm2
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} zmm3 = [4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760]
; AVX512F-NEXT:    vpandnd %zmm1, %zmm3, %zmm1
; AVX512F-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm1
; AVX512F-NEXT:    vpternlogd $216, %zmm3, %zmm2, %zmm1
...
; AVX512VL-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm2
; AVX512VL-NEXT:    vpbroadcastd {{.*#+}} zmm3 = [4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760]
; AVX512VL-NEXT:    vpandnd %zmm1, %zmm3, %zmm1
; AVX512VL-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm1
; AVX512VL-NEXT:    vpternlogd $216, %zmm3, %zmm2, %zmm1
