...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpmulhuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm1
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpbroadcastd {{.*#+}} zmm1 = [4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360]
; AVX512BW-NEXT:    vpandnd %zmm0, %zmm1, %zmm2
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm2
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm3
; AVX512BW-NEXT:    vpternlogd $228, %zmm1, %zmm2, %zmm3
...
; AVX512BW-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm4, %zmm4
...
; AVX512BW-NEXT:    vpsubb %zmm3, %zmm0, %zmm0
...
; AVX512BW-NEXT:    vpackuswb %zmm4, %zmm0, %zmm0
; AVX512BW-NEXT:    vpaddb %zmm3, %zmm0, %zmm0
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm2
; AVX512BW-NEXT:    vpandnd %zmm0, %zmm1, %zmm0
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
; AVX512BW-NEXT:    vpternlogd $216, %zmm1, %zmm2, %zmm0
; AVX512BW-NEXT:    retq
...
; AVX512BW-NEXT:    vpsrlw $8, %zmm3, %zmm3
; AVX512BW-NEXT:    vpackuswb %zmm4, %zmm3, %zmm3
; AVX512BW-NEXT:    vpsubb %zmm3, %zmm0, %zmm4
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} zmm5 = zmm4[8],zmm2[8],zmm4[9],zmm2[9],zmm4[10],zmm2[10],zmm4[11],zmm2[11],zmm4[12],zmm2[12],zmm4[13],zmm2[13],zmm4[14],zmm2[14],zmm4[15],zmm2[15],zmm4[24],zmm2[24],zmm4[25],zmm2[25],zmm4[26],zmm2[26],zmm4[27],zmm2[27],zmm4[28],zmm2[28],zmm4[29],zmm2[29],zmm4[30],zmm2[30],zmm4[31],zmm2[31],zmm4[40],zmm2[40],zmm4[41],zmm2[41],zmm4[42],zmm2[42],zmm4[43],zmm2[43],zmm4[44],zmm2[44],zmm4[45],zmm2[45],zmm4[46],zmm2[46],zmm4[47],zmm2[47],zmm4[56],zmm2[56],zmm4[57],zmm2[57],zmm4[58],zmm2[58],zmm4[59],zmm2[59],zmm4[60],zmm2[60],zmm4[61],zmm2[61],zmm4[62],zmm2[62],zmm4[63],zmm2[63]
; AVX512BW-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm5, %zmm5
; AVX512BW-NEXT:    vpsrlw $8, %zmm5, %zmm5
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} zmm2 = zmm4[0],zmm2[0],zmm4[1],zmm2[1],zmm4[2],zmm2[2],zmm4[3],zmm2[3],zmm4[4],zmm2[4],zmm4[5],zmm2[5],zmm4[6],zmm2[6],zmm4[7],zmm2[7],zmm4[16],zmm2[16],zmm4[17],zmm2[17],zmm4[18],zmm2[18],zmm4[19],zmm2[19],zmm4[20],zmm2[20],zmm4[21],zmm2[21],zmm4[22],zmm2[22],zmm4[23],zmm2[23],zmm4[32],zmm2[32],zmm4[33],zmm2[33],zmm4[34],zmm2[34],zmm4[35],zmm2[35],zmm4[36],zmm2[36],zmm4[37],zmm2[37],zmm4[38],zmm2[38],zmm4[39],zmm2[39],zmm4[48],zmm2[48],zmm4[49],zmm2[49],zmm4[50],zmm2[50],zmm4[51],zmm2[51],zmm4[52],zmm2[52],zmm4[53],zmm2[53],zmm4[54],zmm2[54],zmm4[55],zmm2[55]
; AVX512BW-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm2
; AVX512BW-NEXT:    vpsrlw $8, %zmm2, %zmm2
; AVX512BW-NEXT:    vpackuswb %zmm5, %zmm2, %zmm2
; AVX512BW-NEXT:    vpaddb %zmm3, %zmm2, %zmm2
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm3
; AVX512BW-NEXT:    vpandnd %zmm2, %zmm1, %zmm2
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm2
; AVX512BW-NEXT:    vpternlogd $216, %zmm1, %zmm3, %zmm2
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} zmm1 = zmm2[8,8,9,9,10,10,11,11,12,12,13,13,14,14,15,15,24,24,25,25,26,26,27,27,28,28,29,29,30,30,31,31,40,40,41,41,42,42,43,43,44,44,45,45,46,46,47,47,56,56,57,57,58,58,59,59,60,60,61,61,62,62,63,63]
; AVX512BW-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm1
