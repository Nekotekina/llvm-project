...
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760]
; AVX512DQ-NEXT:    vpandnd %zmm1, %zmm2, %zmm3
; AVX512DQ-NEXT:    vpandnd %zmm0, %zmm2, %zmm4
; AVX512DQ-NEXT:    vpsrlvd %zmm3, %zmm4, %zmm3
; AVX512DQ-NEXT:    vpsrld $16, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpsrlvd %zmm1, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpternlogd $228, %zmm2, %zmm3, %zmm0
; AVX512DQ-NEXT:    retq
;
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360,4278255360]
; AVX512BW-NEXT:    vpandnd %zmm1, %zmm2, %zmm3
; AVX512BW-NEXT:    vpandnd %zmm0, %zmm2, %zmm4
; AVX512BW-NEXT:    vpsrlvw %zmm3, %zmm4, %zmm3
; AVX512BW-NEXT:    vpsrlw $8, %zmm1, %zmm1
; AVX512BW-NEXT:    vpsrlvw %zmm1, %zmm0, %zmm0
; AVX512BW-NEXT:    vpternlogd $228, %zmm2, %zmm3, %zmm0
; AVX512BW-NEXT:    retq
...
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vpbroadcastd {{.*#+}} zmm1 = [4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760,4294901760]
; AVX512DQ-NEXT:    vpandnd %zmm0, %zmm1, %zmm2
; AVX512DQ-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm2
; AVX512DQ-NEXT:    vpsrlvd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
; AVX512DQ-NEXT:    vpternlogd $228, %zmm1, %zmm2, %zmm0
; AVX512DQ-NEXT:    retq
;
...
; AVX512BW-NEXT:    vpsrlvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
; AVX512BW-NEXT:    vpternlogd $228, %zmm1, %zmm2, %zmm0
; AVX512BW-NEXT:    retq
